...
**MANDATORY REQUIREMENT:** When instructed to read this prompt file (MCP_YouTrack_AI_Promt_Smoke.md):
...
1. Check file size: `wc -l MCP_YouTrack_AI_Promt_Smoke.md`
2. Read complete file: `Bash: cat MCP_YouTrack_AI_Promt_Smoke.md`
...
- [ ] Total lines read: _____ (record actual count from `wc -l`)
...
|------------|-------|------|------|--------|
| **🔴 P0 Critical** | ___ | ___ | ___ | **100% Pass Required** |
| **🟡 P1 Important** | ___ | ___ | ___ | **>75% Pass Expected** |
| **🟢 P2 Nice-to-have** | ___ | ___ | ___ | **Ignored for GO decision** |
| **TOTAL** | ___ | ___ | ___ | **Decision: ________** |
...
### **When to Use Full MCP_YouTrack_AI_Promt.md:**
